        ...
        <table class="data-table">
            <thead>
                <tr>
                    ...
                    <th class="nilai-col" rowspan="2">NILAI<br>MINGGUAN</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="hari-col">{{ $siswa->penilaianMingguan->nilai_mingguan_hari_1 }}</td>
                    <td class="hari-col">{{ $siswa->penilaianMingguan->nilai_mingguan_hari_2 }}</td>
                    <td class="hari-col">{{ $siswa->penilaianMingguan->nilai_mingguan_hari_3 }}</td>
                    <td class="hari-col">{{ $siswa->penilaianMingguan->nilai_mingguan_hari_4 }}</td>
                    <td class="hari-col">{{ $siswa->penilaianMingguan->nilai_mingguan_hari_5 }}</td>
                    <td class="hari-col">{{ $siswa->penilaianMingguan->nilai_mingguan_hari_6 }}</td>
                    <td class="hari-col">{{ $siswa->penilaianMingguan->nilai_mingguan_hari_7 }}</td>
                    <td class="nilai-col">{{ $siswa->penilaianMingguan->nilai_mingguan }}</td>
                    <td class="rank-col">{{ $siswa->penilaianMingguan->rank_mingguan }}</td>
                    <td class="text-left keterangan-col">{{ $siswa->penilaianMingguan->keterangan }}</td>
                </tr>
                @endif
                @endforeach
            </tbody>
