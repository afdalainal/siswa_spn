        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $siswa->penilaianHarian->nilai_harian_1 }}</td>
                    <td>{{ $siswa->penilaianHarian->nilai_harian_2 }}</td>
                    <td>{{ $siswa->penilaianHarian->nilai_harian_3 }}</td>
                    <td>{{ $siswa->penilaianHarian->nilai_harian_4 }}</td>
                    <td>{{ $siswa->penilaianHarian->nilai_harian_5 }}</td>
                    <td>{{ $siswa->penilaianHarian->nilai_harian_6 }}</td>
                    <td>{{ $siswa->penilaianHarian->nilai_harian_7 }}</td>
                    <td>{{ number_format($rataRata, 2) }}</td>
                    <td class="text-left">{{ $siswa->penilaianHarian->keterangan }}</td>
                </tr>
                @endif
                @endforeach
            </tbody>
