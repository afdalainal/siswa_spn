        ...
        <div class="card-body">
            <form action="{{ route('penilaianpengamatan.update', $penilaianpengamatan->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="mental_kejuangan_2">Mental Kejuangan 1</label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="mental_kejuangan_3">Mental Kejuangan 1</label>
                            <input type="number" id="mental_kejuangan_3" name="mental_kejuangan_3"
                                class="form-control square" placeholder="Input nilai"
                                value="{{ old('mental_kejuangan_3', $penilaianpengamatan->mental_spiritual_1) }}">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" id="skor" name="skor" class="form-control square"
                                placeholder="Input nilai" value="{{ old('skor', $penilaianpengamatan->skor) }}">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
